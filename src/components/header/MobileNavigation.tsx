...
import DrawerWave from 'assets/icons/custom/DrawerWave.tsx';
        ...
        <div className="flex items-center justify-between h-full">
            ...
            <AnimatePresence>
                {isOpen && (
                    <>
                        <motion.div
                            className="fixed inset-0 z-40 bg-black/50 touch-none will-change-[opacity]" // evtl. backdrop-blur-xs
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                        ...
                        <motion.div
                            ref={drawerRef}
                            style={{
                                backgroundImage: `linear-gradient(rgba(255,255,255,0.5), rgba(255,255,255,0.5)), url('/images/background.svg')`,
                        ...
                        >
                            ...
                            {/* Close Button */}
                            <div className={clsx(
                                "flex items-center justify-end p-5",
                                scrolled ? "h-20" : "h-36",
                            )}>
                                <button
                                    onClick={closeDrawer}
