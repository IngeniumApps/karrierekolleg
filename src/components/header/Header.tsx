  ...
  return (
      <header
          className={clsx(
              ...
              scrolled ? 'bg-primary shadow-md h-20' : 'lg:bg-white bg-transparent h-36 lg:overflow-hidden',
          )}
      >
        {/* 🎨 Blob-Deko links */}
        {!scrolled && (
        ...
        <div className="relative max-w-7xl mx-auto px-5 flex items-center justify-between h-full z-10">
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            {!scrolled && (
                <motion.a
                    href="#start"
                    className="bg-lime-300 text-black font-bold px-5 py-2 -rotate-3 rounded-full hover:rotate-0 hover:scale-105 transition-transform"
