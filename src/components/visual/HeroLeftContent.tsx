/* src/components/visual/HeroLeftContent.tsx */
...
export default function HeroLeftContent() {
    return (
        ...
        <span className="inline-block font-black text-[10vw] sm:text-6xl md:text-7xl lg:text-8xl text-primary">
          <TypewriterText words={['Karriere', 'Zukunft', 'Bildung']} loop={Infinity} cursorStyle="_" />
        </span>
                <br />
                neu denken.<br />
          ...
          <UnderlineBrush className="hidden lg:block absolute left-0 bottom-0 z-0 w-full" fillColor="#BBF451" bottomOffset={5} />
        </span>
                starten.
            </h1>

            <p className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                Mit einem Kolleg eröffnest du dir neue Wege – praxisnah, berufsbegleitend und staatlich anerkannt.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <a href={`${import.meta.env.BASE_URL}#kollegs`} className="inline-block bg-white text-primary font-bold border border-primary px-8 py-4 rounded-full shadow-md">
