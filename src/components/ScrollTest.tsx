        ...
        <div>
            <nav className="fixed top-0 bg-white w-full shadow z-50 p-4">
                <ul className="flex gap-4 justify-center">
                    <li>
                        <Link to="section1" smooth={true} duration={500} className="cursor-pointer text-blue-600">
                            Section 01
                        </Link>
                    </li>
                    <li>
                        <Link to="section2" smooth={true} duration={500} className="cursor-pointer text-blue-600">
                            Section 02
                        </Link>
                    </li>
                </ul>
