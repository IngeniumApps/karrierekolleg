...
import CardFlowLineMirrored from '@components/visual/animation/CardFlowLineMirrored';
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6">
              ...
              <span className="font-black relative inline-block text-[11vw] sm:text-6xl md:text-7xl lg:text-8xl">
                ...
                <FadeDownOnScroll duration={0.8} delay={0.2}>
                    <div
                        className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100 text-center mb-20">
                        <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
                            ...
                            <p className="text-base lg:text-lg mb-6">
                                ...
                                <strong>Stufe 6 im Nationalen Qualifikationsrahmen</strong>. Damit stehst du auf derselben Stufe wie ein:e Bachelorabsolvent:in
                            </p>
                            <p className="text-base lg:text-lg">
                                ...
                                <strong> ausgezeichnete Jobchancen in nationalen und internationalen
                                    Unternehmen</strong> garantiert.
                            </p>
                        </div>
                    </div>
                </FadeDownOnScroll>
                ...
                <FadeDownOnScroll duration={0.8} delay={0.4}>
                    <div
                        className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100 text-center">
                        <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
                            <p className="text-xl lg:text-2xl font-semibold text-primary mb-6">
