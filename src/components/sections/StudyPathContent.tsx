    ...
    return (
        <section className="relative w-full py-20 lg:py-32 overflow-hidden">
            ...
            <div className="bg-white border-l-4 border-primary px-6 py-4 rounded-lg text-left text-base sm:text-lg leading-relaxed">
                <p>
                    Ein speziell für HTL-Absolvent:innen und damit natürlich auch für HTL-Kolleg-Absolvent:innen entwickeltes Modell findest du unter{' '}
                    <a
                    ...
                    . Die volle Kolleg-Ausbildung wird dort anerkannt – du kannst in zwei Jahren mit dem akademischen Grad <strong>Dipl.-Ing. (FH)</strong> abschließen.
                </p>
            </div>
